#ifndef CELLITEM_NEW_H
#define CELLITEM_NEW_H
...
public:
    ...
    QList<Connector> getConnectors() const { return m_connectors; } // 获取所有连接点
    QList<PinItem*> getPinItems() const { return m_pinItems; }    // 获取 PinItem 列表
