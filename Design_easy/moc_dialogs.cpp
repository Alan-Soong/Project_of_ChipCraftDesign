...
template <> constexpr inline auto Dialogs::qt_create_metaobjectdata<qt_meta_tag_ZN7DialogsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_pinMoved'
        QtMocHelpers::SlotData<void(PinItem *)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'saveSetting'
        ...
        QtMocHelpers::SlotData<void(const QPointF &)>(16, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QPointF, 17 },
        }}),
    };
...
void Dialogs::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_pinMoved((*reinterpret_cast< std::add_pointer_t<PinItem*>>(_a[1]))); break;
        case 3: _t->saveSetting(); break;
        case 4: _t->on_nameEdit_textEdited((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 5: _t->on_saveButton_clicked(); break;
        case 6: _t->on_colorCombo_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->on_addPinButton_clicked(); break;
        case 8: _t->on_pinSceneClicked((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        default: ;
        }
    }
